...
export default function Instagram() {
  ...
  return (
    <div>
      ...
      <div>
        <table className='w-40 h-40 mx-auto overflow-hidden'>
          <tbody>
            <tr>
              <td className='h-full w-full relative overflow-hidden'>
                ...
                <div className='h-25 w-25 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' style={{border:'1px solid red'}}></div>
                {/* <div className='h-full w-full bg-center bg-contain bg-cover bg-no-repeat overflow-hidden' style={{backgroundImage: `url(${image})`}}>
                  <div className='h-20 w-20 absolute' style={{border:'1px solid red', transform: `translate(${-imageX+20}%,${-imageY+20}%) scale(${200-(imageZoom)}%)`}}></div>
                </div> */}
              </td>
              <td className='h-full w-full'>
                <Slider aria-label='slider-ex-1' isReversed className='rotate-180= ml-4' defaultValue={0} min={-100} max={100} onChange={(v)=>{setImageY(v)}} orientation='vertical' minH='100px'>
                  <SliderTrack>
                    <SliderFilledTrack />
                  </SliderTrack>
                  <SliderThumb />
      ...
      <BaseCard ref={ref}>
        <div className={`min-w-[250px] max-w-[250px] z-0 relative min-h-[350px] max-h-[350px] h-[350px]  origin-top flex flex-col`}>
          <div className='flex justify-between px-2 py-2 bg-white'>
            <img src="/images/instagram/logo.webp" alt="logo" className='w-16 h-auto' />
            <div className='flex gap-4'>
              <img src="/images/instagram/like.svg" alt="" className='w-4' />
              <img src="/images/instagram/messenger.svg" alt="" className='w-4' />
            </div>
          </div>
          ...
          <div className='flex p-2 items-center bg-white'>
            <div className='bg-gradient-to-rt from-[#FCCE10] via-[#FA0C65] to-[#D009B9] p-[1px] rounded-full'>
              <div className='bg-white rounded-full p-[1px]'>
                {head?
                <div className='w-5 h-5 rounded-full bg-center bg-contain bg-cover bg-no-repeat' style={{backgroundImage: `url(${head})`}} />:
                <div className='w-5 h-5 rounded-full bg-zinc-50' />
                }
              </div>
            </div>
          ...
          <div className='flex items-center p-2 gap-3 bg-white'>
            <img src="/images/instagram/liked.svg" alt="liked" className='w-4' />
            <img src="/images/instagram/message.svg" alt="message" className='w-4' />
            <img src="/images/instagram/send.svg" alt="send" className='w-4' />
            <div className='flex-1'></div>
            <img src="/images/instagram/collect.svg" alt="collect" className='w-4' />
          </div>
          <div className='px-2 pb-2 text-[0.6rem] flex-1 bg-white'>
            <HighText show={highLight} text='文案' eg='点我看群主女装' />
          </div>
          <div className='w-full h-[1px] bg-#E8E8E8'></div>
          <div className='flex items-center justify-between py-2 px-4 bg-white'>
            <img src="/images/instagram/home.svg" alt="home" className='w-4' />
            <img src="/images/instagram/search.svg" alt="search" className='w-4' />
            <img src="/images/instagram/add.svg" alt="add" className='w-4' />
            <img src="/images/instagram/video.svg" alt="video" className='w-4' />
            <img src="/images/instagram/user.svg" alt="user" className='w-4' />
